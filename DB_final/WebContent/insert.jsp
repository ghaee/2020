...
<br>
<tr><th>과목번호</th><th>분반</th><th>과목명</th><th>학점</th><th>정원</th>
      <th>수강신청</th></tr>
<%
...
try{
    ...
    myConn=DriverManager.getConnection(dburl, user, passwd);
  	...
  	mySQL = "select c_id,c_id_no,c_name,c_unit,c_personnel from course where c_id not in (select c_id from enroll where s_id='" + session_id + "') order by c_id ASC";
